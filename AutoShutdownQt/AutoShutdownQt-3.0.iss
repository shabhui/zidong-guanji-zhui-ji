...
#define MyAppExeName "AutoShutdownQt.exe"
...
AllowNoIcons=yes
OutputDir=..\dist
OutputBaseFilename=AutoShutdownQt-3.0-Setup
Compression=lzma
...
[Files]
Source: "..\dist\AutoShutdownQt-3.0\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
